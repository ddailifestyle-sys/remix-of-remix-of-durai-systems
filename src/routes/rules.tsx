  ...
  head: () => ({
    meta: [
      { title: "Rules & Guidelines — IoT SimLab" },
      {
        name: "description",
        content:
          "Official rules of the IoT Simulation Challenge: eligibility, simulation rules, scoring criteria and submission requirements.",
      },
...
const SECTIONS = [
  {
    ...
    title: "General Rules",
    items: [
      "Registration is individual — one account per participant.",
      "Duplicate accounts will be disqualified.",
      "You must carry a valid college ID during the event.",
      "Participants must use only the official IoT SimLab platform for simulation.",
  ...
  },
  {
    ...
    items: [
      ...
      "Firmware must be written by you — no pre-built project imports.",
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 py-14 lg:grid-cols-2 lg:px-8">
          <div>
            ...
            <p className="mt-5 max-w-xl text-muted-foreground">
              Everything you must follow during the IoT Simulation Challenge. Read carefully —
        ...
        <div className="mx-auto grid max-w-7xl gap-6 px-4 lg:grid-cols-2 lg:px-8">
          ...
          <div className="panel border-warning/40 bg-warning/5 p-7 lg:col-span-2">
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              Sharing solutions with others, using external simulators, or attempting to tamper
              with the evaluation system will lead to immediate disqualification.
            </p>
            <Link
              to="/register"
