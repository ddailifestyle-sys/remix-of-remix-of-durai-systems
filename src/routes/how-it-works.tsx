...
const STAGES = [
  {
    title: "Register",
    text: "Create your individual account with your details and login credentials.",
  },
  {
    title: "Choose a problem",
    text: "Browse the problem library, filter by difficulty and open the statement that fits you.",
  },
  {
      ...
      <section className="hero-glow border-b border-border py-16">
        <div className="mx-auto max-w-3xl px-4 text-center">
          ...
          <p className="mt-5 text-muted-foreground">
            Five stages take you from sign-up to a scored submission.
          </p>
        </div>
      </section>
