  ...
  head: () => ({
    meta: [
      { title: "FAQ — IoT SimLab" },
      {
        name: "description",
        content:
          "Frequently asked questions about participation, hardware requirements, scoring, retries and submissions in IoT SimLab.",
      },
...
const FAQS = [
  {
    q: "Do I need physical IoT hardware?",
    a: "No. Every component in the problem statements is available in the virtual simulation lab, so you can build and test entirely in the browser.",
  },
  {
    q: "Is this a team or individual challenge?",
    a: "Registration is individual — you sign up and compete on your own. One account per participant.",
  },
  {
