  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "IoT SimLab — Build. Simulate. Innovate." },
      {
        ...
        content: "A virtual IoT lab: design, simulate, analyze and submit.",
      },
    ],
  }),
  component: Landing,
...
const STATS = [
  ...
  { icon: Users, label: "Participants", value: "Solo" },
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 py-16 lg:grid-cols-2 lg:px-8 lg:py-24">
          <div>
            ...
            <p className="mt-6 max-w-xl text-base leading-relaxed text-muted-foreground sm:text-lg">
              Welcome to IoT SimLab — a fully virtual laboratory where participants design IoT
      ...
      <section className="border-t border-border bg-sidebar py-16">
        <div className="mx-auto max-w-3xl px-4 text-center">
          ...
          <p className="mt-3 text-muted-foreground">
            Register, pick a problem and open the simulation lab in minutes.
          </p>
