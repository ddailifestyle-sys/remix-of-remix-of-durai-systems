...
const EVENTS = [
  { date: "01 May 2025", title: "Registration Opens", text: "Participants can register and verify their college details." },
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="hero-glow border-b border-border py-16">
        <div className="mx-auto max-w-3xl px-4 text-center">
          ...
          <p className="mt-5 text-muted-foreground">Mark these dates so you never miss a stage.</p>
        </div>
      </section>
