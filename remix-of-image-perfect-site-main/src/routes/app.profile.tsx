...
export const Route = createFileRoute("/app/profile")({
  head: () => ({
    meta: [
      { title: "Team Profile — IoT SimLab" },
      { name: "description", content: "Your team details, stats and earned badges." },
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-[1.3fr_1fr]">
        <section className="panel p-7">
          ...
          <ul className="mt-4 space-y-3">
            {team.members.map((m, i) => (
              <li key={i} className="flex items-center gap-4 rounded-xl border border-border bg-surface-2 p-4">
        ...
        <section className="panel p-7">
          ...
          <h2 className="mt-8 text-base font-semibold">Team Bio</h2>
          <textarea
            rows={3}
            value={about}
