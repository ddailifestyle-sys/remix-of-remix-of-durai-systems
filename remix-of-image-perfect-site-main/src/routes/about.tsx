  ...
  head: () => ({
    meta: [
      { title: "About the Challenge — IoT SimLab" },
      {
        name: "description",
        content:
          "Learn why IoT SimLab exists, who it is for and what student teams gain from the virtual IoT simulation challenge.",
      },
      { property: "og:title", content: "About the Challenge — IoT SimLab" },
      {
        property: "og:description",
        content: "A virtual IoT lab built so every student team can build without hardware.",
      },
    ],
  }),
  component: AboutPage,
...
const CARDS = [
  ...
  },
  {
    ...
    text: "Team-based registration, structured problem sets and automated scoring designed for campus events.",
  },
  {
    icon: Globe2,
    title: "Zero Setup",
      ...
      <section className="hero-glow border-b border-border py-16">
        <div className="mx-auto max-w-3xl px-4 text-center">
          ...
          <p className="mt-5 text-muted-foreground">
            ...
            Challenge. Teams solve real-world IoT problems by designing circuits, writing firmware
